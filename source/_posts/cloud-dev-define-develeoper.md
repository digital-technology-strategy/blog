...
- **业务导向团队（Stream-aligned team）**，又可称为端到端的团队，它是指匹配业务领域或组织能力的持续流动的工作任务的团队。它对应于一个产品、一项服务、一组功能特性等。成熟 的产品导向团队，能端到端地完成交付用户价值，而无需将部分工作交由其它团队完成。
...
PS：业务导向团队（Stream-aligned team），在书中译为流动式团队，一个容易产生歧义的翻译。我的同事建议翻译成价值流团队。在这里，我还是使用业务导向团队，方便于大家能快速理解 。
...
赋能团队的关键是，实现**共创**，即与其它团队一起产生价值。从模式来看，他们需要提供更好的服务，以改善开发者们的体验。
