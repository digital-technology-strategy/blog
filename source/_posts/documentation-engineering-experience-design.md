---
layout: default
title: 文档工程体验设计：重塑开发者体验
date: 2021-09-27 21:06:58
tags:
    - 开发者体验
    - 文档工程体验
author:
...
最近，一边在思考如何进行[开发者体验](https://www.phodal.com/blog/developer-experience/)优化，一边在设计新的文档体系，以确保文档和代码的一致性。于是，便结合我先前对于文档代码化的理解和实践，并展开对于 Rust、Julia、Dart、Kotlin、Swift 等语言的文档研究（详细见：《[API 库的文档体系支持：主流编程语言的文档设计](https://www.phodal.com/blog/api-ducumentation-design-dsl-base/)》），重新思考了如何做了文档工程的开发者体验设计。
